...
class QuestionModelTests(TestCase):
    def test_was_published_recently_with_future_question(self):
        """
            Devuelve False para preguntas cuyo fecha_publicacion esté en el futuro
        """
        time= timezone.now() + datetime.timedelta(days=30)
        future_question= Question(fecha_publicacion=time)
    ...
    def test_was_published_recently_with_old_question(self):
        ...
        old_question= Question(fecha_publicacion=time)
    ...
    def test_was_published_recently_with_recent_question(self):
        ...
        recent_question= Question(fecha_publicacion=time)
...
def create_question(question_text, days):
    ...
    return Question.objects.create(question_text=question_text, fecha_publicacion=time)
